...
public class UTF8EncodeActionHandler extends AbstractHandler {
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        EncodeToUTF8EditorAction action = new EncodeToUTF8EditorAction();
        if (javaEditor != null) {
            action = new EncodeToUTF8EditorAction();
